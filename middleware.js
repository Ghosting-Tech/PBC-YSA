...
const protectedRoutes = {
  admin: ["/admin", "/my-tickets"], // Admin can access my-tickets
  serviceProvider: ["/service-provider", "/my-tickets"], // Service providers can access my-tickets
  user: ["/user", "/my-tickets"], // Users can access my-tickets
};
