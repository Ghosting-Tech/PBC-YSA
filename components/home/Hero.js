            ...
            <div className="container mx-auto px-4 h-full flex items-center">
              <div className="max-w-2xl space-y-6 text-center sm:text-left">
                ...
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color)]/10 text-[var(--color)]  border border-purple-500/20 mx-auto sm:mx-0"
                >
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="relative p-4 rounded-xl border border-gray-700 bg-gray-900/50">
                        <div className="text-[var(--color)]  mb-2">
                          {stat.icon}
                        </div>
