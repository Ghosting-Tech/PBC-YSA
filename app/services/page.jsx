    ...
    <>
      ...
      >
        <div className="w-full flex flex-col justify-center items-center mt-8 px-4">
          ...
          <h2 className="font-cookie font-medium w-full md:w-auto flex justify-center md:justify-start lg:text-6xl md:text-6xl sm:text-5xl text-5xl text-center text-blue-500 ">
            Best Services
          </h2>
        </div>
        <ServiceContainer
